...
```
python3 AutoSearch_final_WangSY20241208.py -p /storage/guotiannanLab/xingziyuan/01.metaMS-GPT/00.training_dataset/01.single.species/00.bacteria/00.test/ -i species.txt
```
